...
!function() {
    ...
    window.tram = function(t) {
        ...
        M.transform && M.backface && (J.z = [k, "translateZ"],
        J.rotateZ = [_],
        J.scaleZ = [b],
        J.perspective = [x]);
        var V = /ms/
   ...
   */
      ...
      , r = t(function(t) {
        ...
        f.env.safari = /safari/.test(_) && !O && !j;
        var A;
        E && g.on("touchstart mousedown", function(t) {
            A = t.target
        }),
    ...
    t(function(t) {
        ...
        e.define("edit", t.exports = function(t, n, i) {
            ...
            var l, f = {}, h = t(window), d = t(document.documentElement), p = document.location, v = "hashchange", m = i.load || function() {
                l = !0,
            ...
            return g ? m() : p.search ? (/[?&](edit)(?:[=&?]|$)/.test(p.search) || /\?edit$/.test(p.href)) && m() : h.on(v, r).triggerHandler(v),
            f
        }
        )
    }),
   ...
   */
    ...
    t(function(t) {
        ...
        e.define("forms", t.exports = function(t, n) {
            ...
            var p, v, m, g = {}, w = t(document), b = window.location, y = window.XDomainRequest && !window.atob, x = ".w-form", k = /e(-)?mail/i, _ = /^\S+@\S+$/, T = window.alert, E = e.env(), O = /list-manage[1-9]?.com/i, j = n.debounce(function() {
    ...
    t(function(t) {
        ...
        e.define("ix", t.exports = function(t, i) {
            ...
            function o() {
                ...
                i.length && (i.each(u),
                i.each(a),
                j.length && (e.scroll.on(c),
                setTimeout(c, 1)),
                A.length && e.load(l),
                z.length && setTimeout(f, $),
                n.init(),
                e.redraw.up())
            }
            function a(r, o) {
            ...
            function c() {
                for (var t = w.scrollTop(), e = w.height(), n = j.length, i = 0; i < n; i++) {
                    var r = j[i]
                      , o = r.el
                      , a = r.trigger
            ...
            var v, m, g = {}, w = t(window), b = ".w-ix", y = t.tram, x = e.env, k = x(), _ = x.chrome && x.chrome < 35, T = "none 0s ease 0s", E = t(), O = {}, j = [], A = [], z = [], $ = 1, q = {
    ...
    t(function(t) {
        function e(t, e, n, i) {
            function r(t, e) {
                ...
                p(y.content, "group")),
                k(v(y.lightbox, "hide").focus()).add("opacity .3s").start({
                    opacity: 1
                }),
                p(y.html, "noscroll"),
                r.show(e || 0)
            ...
            function p(t, e) {
                return t.addClass(h(e))
            }
            function v(t, e) {
                return t.removeClass(h(e))
            }
            function m(t, e, n) {
                return t.toggleClass(h(e), n)
            }
            function g(t, i) {
            ...
            var b, y, x, k = n.tram, _ = Array.isArray, T = "w-lightbox-", E = /(^|\s+)/g, O = [];
            r.build = function() {
                return r.destroy(),
                y = {
                ...
                y.spinner = g("spinner"),
                y.strip = g("strip"),
                x = new f(y.spinner,h("hide")),
                y.content = g("content").append(y.spinner, y.arrowLeft, y.arrowRight, y.close),
                y.container = g("container").append(y.content, y.strip),
                y.lightbox = g("backdrop hide").append(y.container),
                y.strip.on("tap", d("item"), $),
                y.content.on("swipe", q).on("tap", d("left"), j).on("tap", d("right"), A).on("tap", d("close"), z).on("tap", d("image, caption"), A),
                y.container.on("tap", d("view, strip"), z).on("dragstart", d("img"), a),
                y.lightbox.on("keydown", s).on("focusin", M),
            ...
            r.show = function(t) {
                if (t !== b) {
                    ...
                    c(e.html && w(e.width, e.height) || e.url, function(r) {
                        function o() {
                            x.hide(),
                            t === b ? (m(y.arrowLeft, "inactive", t <= 0),
                            m(y.arrowRight, "inactive", t >= O.length - 1),
                            y.view ? (k(y.view).add("opacity .3s").start({
                                opacity: 0
                            }).then(l(y.view)),
                            k(f).add("opacity .3s").add("transform .3s").set({
                                x: t > i ? "80px" : "-80px"
                            }).start({
                                opacity: 1,
                                x: 0
                            ...
                            y.view = f,
                            y.items && p(v(y.items, "active").eq(t), "active")) : f.remove()
                        }
                        if (t === b) {
                            var a, s, u = g("figure", "figure").append(p(r, "image")), c = g("frame").append(u), f = g("view").append(c);
                            e.html && ((s = (a = n(e.html)).is("iframe")) && a.on("load", o),
                            u.append(p(a, "embed"))),
                            e.caption && u.append(g("caption", "figcaption").text(e.caption)),
                            y.spinner.before(f),
                            s || o()
                        }
                    }),
            ...
            var j = o(r.prev)
              ...
              , q = function(t, e) {
                t.preventDefault(),
                "left" === e.direction ? r.next() : "right" === e.direction && r.prev()
            }
              , M = function() {
                this.focus()
            };
        ...
        n.define("lightbox", t.exports = function(t) {
            function i(t) {
                ...
                if (i) {
                    ...
                    o(i),
                    (e = i.group) ? ((n = u[e]) || (n = u[e] = []),
                    t.items = n,
                    i.items.length && (t.index = n.length,
                    n.push.apply(n, i.items))) : t.items = i.items
                } else
                    t.items = []
            }
            function r(t) {
            ...
            var a, s, u, c = {}, l = n.env(), f = e(window, document, t, l ? "#lightbox-mountpoint" : "body"), h = t(document), d = ".w-lightbox";
            return c.ready = c.design = c.preview = function() {
                s = l && n.env("design"),
                f.destroy(),
                u = {},
                (a = h.find(d)).webflowLightBox()
            }
            ,
            jQuery.fn.extend({
                webflowLightBox: function() {
                    ...
                    t.each(e, function(e, n) {
                        ...
                        o.el.off(d),
                        i(o),
                        s ? o.el.on("setting" + d, i.bind(null, o)) : o.el.on("tap" + d, r(o)).on("click" + d, function(t) {
                            t.preventDefault()
                        })
                    })
                }
    ...
    t(function(t) {
        ...
        e.define("links", t.exports = function(t, n) {
            ...
            var a, s, u, c = {}, l = t(window), f = e.env(), h = window.location, d = document.createElement("a"), p = "w--current", v = /^#[\w:.-]+$/, m = /index\.(html|php)$/, g = /\/$/;
            return c.ready = c.design = c.preview = function() {
                a = f && e.env("design"),
    ...
    t(function(t) {
        ...
        e.define("navbar", t.exports = function(t, i) {
            ...
            function s(e, n) {
                ...
                f(r),
                T ? (c(r),
                r.el.on("setting" + q, h(r))) : (l(r),
                r.button.on("tap" + q, p(r)),
                r.menu.on("click" + q, "a", v(r))),
                g(e, n)
            }
            function u(e, n) {
                var i = t.data(n, q);
            ...
            function m(e) {
                return e.outside && A.off("tap" + q, e.outside),
            ...
            function x(t, e) {
                ...
                if (t.open) {
                    ...
                    C.outro(0, t.el[0]),
                    A.off("tap" + q, t.outside),
                    e)
                        return O(t.menu).stop(),
                        void n();
            ...
            var k, _, T, E = {}, O = t.tram, j = t(window), A = t(document), z = e.env(), $ = '<div class="w-nav-overlay" data-wf-ignore />', q = ".w-nav", M = "w--open", L = "w--nav-menu-open", D = "w--nav-link-open", C = n.triggers, S = t();
            E.ready = E.design = E.preview = function() {
                T = z && e.env("design"),
                k = t(document.body),
                (_ = A.find(q)).length && (_.each(s),
                r(),
                o())
            }
            ,
    ...
    t(function(t) {
        o.define("touch", t.exports = function(t) {
            function e(t) {
                ...
                function i(t) {
                    if (l) {
                        ...
                        var e = t.touches
                          ...
                          , p = i - c;
                        c = i,
                        Math.abs(p) > d && o && "" === String(o()) && (n("swipe", t, {
                ...
                var s, u, c, l = !1, f = !1, h = !1, d = Math.min(Math.round(.04 * window.innerWidth), 40);
